...
$(document).ready(function () {
    Vue.component("navbar-links", __webpack_require__(41));
    Vue.component("purchase", __webpack_require__(55));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("/json/category/all").then(function (response) {
            _this.categories = response.data;
        });
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("/json/brand/all").then(function (response) {
    ...
    _c("li", { staticClass: "dropdown" }, [
      ...
      _c(
        ...
        _vm._l(_vm.categories, function(category) {
          return _c("li", [
            _c("a", { attrs: { href: "/categorias/" + category.category } }, [
    ...
    _c("li", { staticClass: "dropdown" }, [
      ...
      _c(
        ...
        _vm._l(_vm.brands, function(brand) {
          return _c("li", [
            _c("a", { attrs: { href: "/marcas/" + brand.brand } }, [
...
Component.options.__file = "resources\\assets\\js\\components\\Purchase.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f2867a10", Component.options)
  } else {
    hotAPI.reload("data-v-f2867a10", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("form", { attrs: { action: "", method: "post" } }, [
          ...
          on: {
            change: [
              function($event) {
                ...
                _vm.state_id = $event.target.multiple
                  ? $$selectedVal
                  : $$selectedVal[0]
              },
    ...
    _c("div", { staticClass: "form-group" }, [
      ...
      _c(
        "select",
        { staticClass: "form-control", attrs: { name: "municipality_id" } },
        _vm._l(_vm.municipalities, function(municipality) {
          return _c("option", { domProps: { value: municipality.id } }, [
            _vm._v(_vm._s(municipality.municipality))
          ])
        })
      )
    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f2867a10", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("/json/state/all").then(function (response) {
        ...
        getMunicipalities: function getMunicipalities() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("/json/state/" + this.state_id).then(function (response) {
